...
//go:embed ContactDiscovery.pb.raw
...
func file_ContactDiscovery_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ContactDiscovery_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_ContactDiscovery_proto_msgTypes[1].Exporter = func(v any, i int) any {
