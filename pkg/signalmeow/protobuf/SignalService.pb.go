...
type DataMessage struct {
	...
	GiftBadge               *DataMessage_GiftBadge       `protobuf:"bytes,22,opt,name=giftBadge" json:"giftBadge,omitempty"` // NEXT ID: 24
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
var file_SignalService_proto_msgTypes = make([]protoimpl.MessageInfo, 82)
var file_SignalService_proto_goTypes = []any{
	...
	(*DataMessage_Payment_Amount)(nil),                                // 65: signalservice.DataMessage.Payment.Amount
	(*DataMessage_Payment_Notification)(nil),                          // 66: signalservice.DataMessage.Payment.Notification
	(*DataMessage_Payment_Activation)(nil),                            // 67: signalservice.DataMessage.Payment.Activation
	(*DataMessage_Payment_Amount_MobileCoin)(nil),                     // 68: signalservice.DataMessage.Payment.Amount.MobileCoin
	(*DataMessage_Payment_Notification_MobileCoin)(nil),               // 69: signalservice.DataMessage.Payment.Notification.MobileCoin
	(*DataMessage_Quote_QuotedAttachment)(nil),                        // 70: signalservice.DataMessage.Quote.QuotedAttachment
	(*DataMessage_Contact_Name)(nil),                                  // 71: signalservice.DataMessage.Contact.Name
	(*DataMessage_Contact_Phone)(nil),                                 // 72: signalservice.DataMessage.Contact.Phone
	(*DataMessage_Contact_Email)(nil),                                 // 73: signalservice.DataMessage.Contact.Email
	(*DataMessage_Contact_PostalAddress)(nil),                         // 74: signalservice.DataMessage.Contact.PostalAddress
	(*DataMessage_Contact_Avatar)(nil),                                // 75: signalservice.DataMessage.Contact.Avatar
	(*TextAttachment_Gradient)(nil),                                   // 76: signalservice.TextAttachment.Gradient
	(*SyncMessage_Sent)(nil),                                          // 77: signalservice.SyncMessage.Sent
	(*SyncMessage_Contacts)(nil),                                      // 78: signalservice.SyncMessage.Contacts
	(*SyncMessage_Blocked)(nil),                                       // 79: signalservice.SyncMessage.Blocked
	(*SyncMessage_Request)(nil),                                       // 80: signalservice.SyncMessage.Request
	(*SyncMessage_Read)(nil),                                          // 81: signalservice.SyncMessage.Read
	(*SyncMessage_Viewed)(nil),                                        // 82: signalservice.SyncMessage.Viewed
	(*SyncMessage_Configuration)(nil),                                 // 83: signalservice.SyncMessage.Configuration
	(*SyncMessage_StickerPackOperation)(nil),                          // 84: signalservice.SyncMessage.StickerPackOperation
	(*SyncMessage_ViewOnceOpen)(nil),                                  // 85: signalservice.SyncMessage.ViewOnceOpen
	(*SyncMessage_FetchLatest)(nil),                                   // 86: signalservice.SyncMessage.FetchLatest
	(*SyncMessage_Keys)(nil),                                          // 87: signalservice.SyncMessage.Keys
	(*SyncMessage_PniIdentity)(nil),                                   // 88: signalservice.SyncMessage.PniIdentity
	(*SyncMessage_MessageRequestResponse)(nil),                        // 89: signalservice.SyncMessage.MessageRequestResponse
	(*SyncMessage_OutgoingPayment)(nil),                               // 90: signalservice.SyncMessage.OutgoingPayment
	(*SyncMessage_PniChangeNumber)(nil),                               // 91: signalservice.SyncMessage.PniChangeNumber
	(*SyncMessage_CallEvent)(nil),                                     // 92: signalservice.SyncMessage.CallEvent
	(*SyncMessage_CallLinkUpdate)(nil),                                // 93: signalservice.SyncMessage.CallLinkUpdate
	(*SyncMessage_CallLogEvent)(nil),                                  // 94: signalservice.SyncMessage.CallLogEvent
	(*SyncMessage_DeleteForMe)(nil),                                   // 95: signalservice.SyncMessage.DeleteForMe
	(*SyncMessage_DeviceNameChange)(nil),                              // 96: signalservice.SyncMessage.DeviceNameChange
	(*SyncMessage_AttachmentBackfillRequest)(nil),                     // 97: signalservice.SyncMessage.AttachmentBackfillRequest
	(*SyncMessage_AttachmentBackfillResponse)(nil),                    // 98: signalservice.SyncMessage.AttachmentBackfillResponse
	(*SyncMessage_Sent_UnidentifiedDeliveryStatus)(nil),               // 99: signalservice.SyncMessage.Sent.UnidentifiedDeliveryStatus
	(*SyncMessage_Sent_StoryMessageRecipient)(nil),                    // 100: signalservice.SyncMessage.Sent.StoryMessageRecipient
	(*SyncMessage_OutgoingPayment_MobileCoin)(nil),                    // 101: signalservice.SyncMessage.OutgoingPayment.MobileCoin
	(*SyncMessage_DeleteForMe_MessageDeletes)(nil),                    // 102: signalservice.SyncMessage.DeleteForMe.MessageDeletes
	(*SyncMessage_DeleteForMe_AttachmentDelete)(nil),                  // 103: signalservice.SyncMessage.DeleteForMe.AttachmentDelete
	(*SyncMessage_DeleteForMe_ConversationDelete)(nil),                // 104: signalservice.SyncMessage.DeleteForMe.ConversationDelete
	(*SyncMessage_DeleteForMe_LocalOnlyConversationDelete)(nil),       // 105: signalservice.SyncMessage.DeleteForMe.LocalOnlyConversationDelete
	(*SyncMessage_AttachmentBackfillResponse_AttachmentData)(nil),     // 106: signalservice.SyncMessage.AttachmentBackfillResponse.AttachmentData
	(*SyncMessage_AttachmentBackfillResponse_AttachmentDataList)(nil), // 107: signalservice.SyncMessage.AttachmentBackfillResponse.AttachmentDataList
	(*ContactDetails_Avatar)(nil),                                     // 108: signalservice.ContactDetails.Avatar
	(*PaymentAddress_MobileCoin)(nil),                                 // 109: signalservice.PaymentAddress.MobileCoin
}
var file_SignalService_proto_depIdxs = []int32{
	...
	11,  // 29: signalservice.ReceiptMessage.type:type_name -> signalservice.ReceiptMessage.Type
	12,  // 30: signalservice.TypingMessage.action:type_name -> signalservice.TypingMessage.Action
	41,  // 31: signalservice.StoryMessage.group:type_name -> signalservice.GroupContextV2
	40,  // 32: signalservice.StoryMessage.fileAttachment:type_name -> signalservice.AttachmentPointer
	37,  // 33: signalservice.StoryMessage.textAttachment:type_name -> signalservice.TextAttachment
	47,  // 34: signalservice.StoryMessage.bodyRanges:type_name -> signalservice.BodyRange
	40,  // 35: signalservice.Preview.image:type_name -> signalservice.AttachmentPointer
	13,  // 36: signalservice.TextAttachment.textStyle:type_name -> signalservice.TextAttachment.Style
	36,  // 37: signalservice.TextAttachment.preview:type_name -> signalservice.Preview
	76,  // 38: signalservice.TextAttachment.gradient:type_name -> signalservice.TextAttachment.Gradient
	14,  // 39: signalservice.Verified.state:type_name -> signalservice.Verified.State
	77,  // 40: signalservice.SyncMessage.sent:type_name -> signalservice.SyncMessage.Sent
	78,  // 41: signalservice.SyncMessage.contacts:type_name -> signalservice.SyncMessage.Contacts
	80,  // 42: signalservice.SyncMessage.request:type_name -> signalservice.SyncMessage.Request
	81,  // 43: signalservice.SyncMessage.read:type_name -> signalservice.SyncMessage.Read
	79,  // 44: signalservice.SyncMessage.blocked:type_name -> signalservice.SyncMessage.Blocked
	38,  // 45: signalservice.SyncMessage.verified:type_name -> signalservice.Verified
	83,  // 46: signalservice.SyncMessage.configuration:type_name -> signalservice.SyncMessage.Configuration
	84,  // 47: signalservice.SyncMessage.stickerPackOperation:type_name -> signalservice.SyncMessage.StickerPackOperation
	85,  // 48: signalservice.SyncMessage.viewOnceOpen:type_name -> signalservice.SyncMessage.ViewOnceOpen
	86,  // 49: signalservice.SyncMessage.fetchLatest:type_name -> signalservice.SyncMessage.FetchLatest
	87,  // 50: signalservice.SyncMessage.keys:type_name -> signalservice.SyncMessage.Keys
	89,  // 51: signalservice.SyncMessage.messageRequestResponse:type_name -> signalservice.SyncMessage.MessageRequestResponse
	90,  // 52: signalservice.SyncMessage.outgoingPayment:type_name -> signalservice.SyncMessage.OutgoingPayment
	82,  // 53: signalservice.SyncMessage.viewed:type_name -> signalservice.SyncMessage.Viewed
	91,  // 54: signalservice.SyncMessage.pniChangeNumber:type_name -> signalservice.SyncMessage.PniChangeNumber
	92,  // 55: signalservice.SyncMessage.callEvent:type_name -> signalservice.SyncMessage.CallEvent
	93,  // 56: signalservice.SyncMessage.callLinkUpdate:type_name -> signalservice.SyncMessage.CallLinkUpdate
	94,  // 57: signalservice.SyncMessage.callLogEvent:type_name -> signalservice.SyncMessage.CallLogEvent
	95,  // 58: signalservice.SyncMessage.deleteForMe:type_name -> signalservice.SyncMessage.DeleteForMe
	96,  // 59: signalservice.SyncMessage.deviceNameChange:type_name -> signalservice.SyncMessage.DeviceNameChange
	97,  // 60: signalservice.SyncMessage.attachmentBackfillRequest:type_name -> signalservice.SyncMessage.AttachmentBackfillRequest
	98,  // 61: signalservice.SyncMessage.attachmentBackfillResponse:type_name -> signalservice.SyncMessage.AttachmentBackfillResponse
	108, // 62: signalservice.ContactDetails.avatar:type_name -> signalservice.ContactDetails.Avatar
	109, // 63: signalservice.PaymentAddress.mobileCoin:type_name -> signalservice.PaymentAddress.MobileCoin
	31,  // 64: signalservice.EditMessage.dataMessage:type_name -> signalservice.DataMessage
	27,  // 65: signalservice.BodyRange.style:type_name -> signalservice.BodyRange.Style
	1,   // 66: signalservice.CallMessage.Offer.type:type_name -> signalservice.CallMessage.Offer.Type
	2,   // 67: signalservice.CallMessage.Hangup.type:type_name -> signalservice.CallMessage.Hangup.Type
	3,   // 68: signalservice.CallMessage.Opaque.urgency:type_name -> signalservice.CallMessage.Opaque.Urgency
	66,  // 69: signalservice.DataMessage.Payment.notification:type_name -> signalservice.DataMessage.Payment.Notification
	67,  // 70: signalservice.DataMessage.Payment.activation:type_name -> signalservice.DataMessage.Payment.Activation
	70,  // 71: signalservice.DataMessage.Quote.attachments:type_name -> signalservice.DataMessage.Quote.QuotedAttachment
	47,  // 72: signalservice.DataMessage.Quote.bodyRanges:type_name -> signalservice.BodyRange
	7,   // 73: signalservice.DataMessage.Quote.type:type_name -> signalservice.DataMessage.Quote.Type
	71,  // 74: signalservice.DataMessage.Contact.name:type_name -> signalservice.DataMessage.Contact.Name
	72,  // 75: signalservice.DataMessage.Contact.number:type_name -> signalservice.DataMessage.Contact.Phone
	73,  // 76: signalservice.DataMessage.Contact.email:type_name -> signalservice.DataMessage.Contact.Email
	74,  // 77: signalservice.DataMessage.Contact.address:type_name -> signalservice.DataMessage.Contact.PostalAddress
	75,  // 78: signalservice.DataMessage.Contact.avatar:type_name -> signalservice.DataMessage.Contact.Avatar
	40,  // 79: signalservice.DataMessage.Sticker.data:type_name -> signalservice.AttachmentPointer
	68,  // 80: signalservice.DataMessage.Payment.Amount.mobileCoin:type_name -> signalservice.DataMessage.Payment.Amount.MobileCoin
	69,  // 81: signalservice.DataMessage.Payment.Notification.mobileCoin:type_name -> signalservice.DataMessage.Payment.Notification.MobileCoin
	6,   // 82: signalservice.DataMessage.Payment.Activation.type:type_name -> signalservice.DataMessage.Payment.Activation.Type
	...
	31,  // 88: signalservice.SyncMessage.Sent.message:type_name -> signalservice.DataMessage
	99,  // 89: signalservice.SyncMessage.Sent.unidentifiedStatus:type_name -> signalservice.SyncMessage.Sent.UnidentifiedDeliveryStatus
	35,  // 90: signalservice.SyncMessage.Sent.storyMessage:type_name -> signalservice.StoryMessage
	100, // 91: signalservice.SyncMessage.Sent.storyMessageRecipients:type_name -> signalservice.SyncMessage.Sent.StoryMessageRecipient
	46,  // 92: signalservice.SyncMessage.Sent.editMessage:type_name -> signalservice.EditMessage
	40,  // 93: signalservice.SyncMessage.Contacts.blob:type_name -> signalservice.AttachmentPointer
	15,  // 94: signalservice.SyncMessage.Request.type:type_name -> signalservice.SyncMessage.Request.Type
	16,  // 95: signalservice.SyncMessage.StickerPackOperation.type:type_name -> signalservice.SyncMessage.StickerPackOperation.Type
	17,  // 96: signalservice.SyncMessage.FetchLatest.type:type_name -> signalservice.SyncMessage.FetchLatest.Type
	18,  // 97: signalservice.SyncMessage.MessageRequestResponse.type:type_name -> signalservice.SyncMessage.MessageRequestResponse.Type
	101, // 98: signalservice.SyncMessage.OutgoingPayment.mobileCoin:type_name -> signalservice.SyncMessage.OutgoingPayment.MobileCoin
	19,  // 99: signalservice.SyncMessage.CallEvent.type:type_name -> signalservice.SyncMessage.CallEvent.Type
	20,  // 100: signalservice.SyncMessage.CallEvent.direction:type_name -> signalservice.SyncMessage.CallEvent.Direction
	21,  // 101: signalservice.SyncMessage.CallEvent.event:type_name -> signalservice.SyncMessage.CallEvent.Event
	22,  // 102: signalservice.SyncMessage.CallLinkUpdate.type:type_name -> signalservice.SyncMessage.CallLinkUpdate.Type
	23,  // 103: signalservice.SyncMessage.CallLogEvent.type:type_name -> signalservice.SyncMessage.CallLogEvent.Type
	102, // 104: signalservice.SyncMessage.DeleteForMe.messageDeletes:type_name -> signalservice.SyncMessage.DeleteForMe.MessageDeletes
	104, // 105: signalservice.SyncMessage.DeleteForMe.conversationDeletes:type_name -> signalservice.SyncMessage.DeleteForMe.ConversationDelete
	105, // 106: signalservice.SyncMessage.DeleteForMe.localOnlyConversationDeletes:type_name -> signalservice.SyncMessage.DeleteForMe.LocalOnlyConversationDelete
	103, // 107: signalservice.SyncMessage.DeleteForMe.attachmentDeletes:type_name -> signalservice.SyncMessage.DeleteForMe.AttachmentDelete
	48,  // 108: signalservice.SyncMessage.AttachmentBackfillRequest.targetMessage:type_name -> signalservice.AddressableMessage
	49,  // 109: signalservice.SyncMessage.AttachmentBackfillRequest.targetConversation:type_name -> signalservice.ConversationIdentifier
	48,  // 110: signalservice.SyncMessage.AttachmentBackfillResponse.targetMessage:type_name -> signalservice.AddressableMessage
	49,  // 111: signalservice.SyncMessage.AttachmentBackfillResponse.targetConversation:type_name -> signalservice.ConversationIdentifier
	107, // 112: signalservice.SyncMessage.AttachmentBackfillResponse.attachments:type_name -> signalservice.SyncMessage.AttachmentBackfillResponse.AttachmentDataList
	24,  // 113: signalservice.SyncMessage.AttachmentBackfillResponse.error:type_name -> signalservice.SyncMessage.AttachmentBackfillResponse.Error
	49,  // 114: signalservice.SyncMessage.DeleteForMe.MessageDeletes.conversation:type_name -> signalservice.ConversationIdentifier
	48,  // 115: signalservice.SyncMessage.DeleteForMe.MessageDeletes.messages:type_name -> signalservice.AddressableMessage
	49,  // 116: signalservice.SyncMessage.DeleteForMe.AttachmentDelete.conversation:type_name -> signalservice.ConversationIdentifier
	48,  // 117: signalservice.SyncMessage.DeleteForMe.AttachmentDelete.targetMessage:type_name -> signalservice.AddressableMessage
	49,  // 118: signalservice.SyncMessage.DeleteForMe.ConversationDelete.conversation:type_name -> signalservice.ConversationIdentifier
	48,  // 119: signalservice.SyncMessage.DeleteForMe.ConversationDelete.mostRecentMessages:type_name -> signalservice.AddressableMessage
	48,  // 120: signalservice.SyncMessage.DeleteForMe.ConversationDelete.mostRecentNonExpiringMessages:type_name -> signalservice.AddressableMessage
	49,  // 121: signalservice.SyncMessage.DeleteForMe.LocalOnlyConversationDelete.conversation:type_name -> signalservice.ConversationIdentifier
	40,  // 122: signalservice.SyncMessage.AttachmentBackfillResponse.AttachmentData.attachment:type_name -> signalservice.AttachmentPointer
	25,  // 123: signalservice.SyncMessage.AttachmentBackfillResponse.AttachmentData.status:type_name -> signalservice.SyncMessage.AttachmentBackfillResponse.AttachmentData.Status
	106, // 124: signalservice.SyncMessage.AttachmentBackfillResponse.AttachmentDataList.attachments:type_name -> signalservice.SyncMessage.AttachmentBackfillResponse.AttachmentData
	106, // 125: signalservice.SyncMessage.AttachmentBackfillResponse.AttachmentDataList.longText:type_name -> signalservice.SyncMessage.AttachmentBackfillResponse.AttachmentData
...
func file_SignalService_proto_init() {
	...
	file_SignalService_proto_msgTypes[37].OneofWrappers = []any{
		(*DataMessage_Payment_Amount_MobileCoin_)(nil),
	}
	file_SignalService_proto_msgTypes[38].OneofWrappers = []any{
		(*DataMessage_Payment_Notification_MobileCoin_)(nil),
	}
	file_SignalService_proto_msgTypes[62].OneofWrappers = []any{
	...
	file_SignalService_proto_msgTypes[78].OneofWrappers = []any{
